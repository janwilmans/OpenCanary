...
#     line:      127
def report_issue(file, filename, line, rule, description, source, category):
...
def split_warning_line(line):
    ...
    return file, filename, line, description
...
def parse(line, source):
    ...
    if ": warning" in line:
        file, filename, line, description = split_warning_line(line)
        ...
        report_issue(file, filename, line, rule, description, source, category)
