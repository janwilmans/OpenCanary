...
# it can be used to discover dead code and/or unused variables
...
echo "Find unique variables, this can take a few minutes..."
...
cat /tmp/uniquewords | xargs -I {} grep -o '[^=]\s{}(;|\s=)' /tmp/bigfile > /tmp/uniquevariables
